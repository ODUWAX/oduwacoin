...
struct Params {
    ...
    bool IsProtocolV2(int nHeight) const { return nHeight >= 1230000; }
	int64_t GetTargetSpacing(int nHeight) const { return IsProtocolV2(nHeight) ? nTargetSpacing : nTargetSpacingV1; }
    int nLastPOWBlock;

    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextOduwacoin   = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The OduwaCoin developers");
    ...
    // draw copyright stuff
    {
		...
		pixPaint.drawText(x, y + 30, copyrightTextOduwacoin);
    }

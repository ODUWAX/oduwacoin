...
const QString BITCOIN_IPC_PREFIX("oduwacoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/oduwacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/oduwacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/oduwacoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click oduwacoin: links
...
//
// OSX-specific way of handling oduwacoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in oduwacoin: URIs

...
{
	const std::string URL_SOURCE_CODE = "<https://github.com/ODUWAX/oduwacoin>";
	const std::string URL_WEBSITE = "<https://oduwacoin.io/>";
	...
	return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
		...
		"\n" +
		FormatParagraph(strprintf("Copyright (C) %i-%i The OduwaCoin Developers", 2018, COPYRIGHT_YEAR)) + "\n" +
		"\n" +
		FormatParagraph(strprintf(_("Please contribute if you find OduwaCoin useful. "

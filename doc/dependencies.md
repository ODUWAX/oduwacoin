...
These are the dependencies currently used by OduwaCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/oduwacoinnl
Keybase  - https://keybase.io/team/oduwacoin/
